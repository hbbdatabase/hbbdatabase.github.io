...
const init_phones = ["Bad Guy 2022 Target"],             // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
...
const targets = [
    { type:"Reference Targets", files:["Bad Guy 2022","Bad Guy","MRS","IEF", "Timmy", "Antdroid", "RikudouGoku","Diffuse Field","Etymotic","Free Field", "Precog", "Redeyes"]    }
];
